...
export class GovernanceToken extends ethereum.SmartContract {
  ...
  try_currentCheckpoint(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "currentCheckpoint",
      "currentCheckpoint():(uint256)",
      []
  ...
  balanceAt(account: Address, checkpoint: BigInt): BigInt {
    let result = super.call(
      "balanceAt",
      "balanceAt(address,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(account),
