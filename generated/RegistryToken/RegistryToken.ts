...
export class RegistryToken extends ethereum.SmartContract {
  static bind(address: Address): RegistryToken {
    return new RegistryToken("RegistryToken", address);
  }
  ...
  safeMint(to: Address, tokenId: BigInt, _data: Bytes): boolean {
    let result = super.call(
      "safeMint",
      "safeMint(address,uint256,bytes):(bool)",
      [
        ethereum.Value.fromAddress(to),
        ethereum.Value.fromUnsignedBigInt(tokenId),
  ...
  safeMint1(to: Address, tokenId: BigInt): boolean {
  ...
  try_safeMint1(to: Address, tokenId: BigInt): ethereum.CallResult<boolean> {
